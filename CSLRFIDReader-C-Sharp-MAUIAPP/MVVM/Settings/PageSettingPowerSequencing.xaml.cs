...
namespace CSLHandheldReader_C_Sharp_MAUIAPP.Maui.Views
{
    ...
    {
        public PageSettingPowerSequencing()
        {
            InitializeComponent();
            ...
            */
            ...
            entryNumberofPower.Text = "3";
            entryPower1.Text = "150";
            entryDWell1.Text = "1000";
            entryPower2.Text = "200";
            entryDWell2.Text = "1000";
            entryPower3.Text = "250";
            entryDWell3.Text = "1000";
            entryPower4.Text = "300";
            entryDWell4.Text = "1000";
            entryPower5.Text = "300";
            entryDWell5.Text = "1000";
            entryPower6.Text = "300";
            entryDWell6.Text = "1000";
            entryPower7.Text = "300";
            entryDWell7.Text = "1000";
            entryPower8.Text = "300";
            entryDWell8.Text = "1000";
            entryPower9.Text = "300";
            entryDWell9.Text = "1000";
            entryPower10.Text = "300";
            entryDWell10.Text = "1000";
            entryPower11.Text = "300";
            entryDWell11.Text = "1000";
            entryPower12.Text = "300";
            entryDWell12.Text = "1000";
            entryPower13.Text = "300";
            entryDWell13.Text = "1000";
            entryPower14.Text = "300";
            entryDWell14.Text = "1000";
            entryPower15.Text = "300";
            entryDWell15.Text = "1000";
            entryPower16.Text = "300";
            entryDWell16.Text = "1000";
        ...
        public async void btnOKClicked(object sender, EventArgs e)
        {
            ...
            */
            ...
            await DisplayAlert("Power Sequencing", "Power sequencing settings saved successfully!", "OK");
        }
    }
}